...
pipeline {
    ...
    post {
        ...
        success {
            ...
            githubNotify context: 'continuous-integration/jenkins/SGX-SIM mode', description: 'commit looks good',  status: 'SUCCESS'
        }
        aborted {
            githubNotify context: 'continuous-integration/jenkins/SGX-SIM mode', description: 'commit looks bad',  status: 'ABORTED'
            error "Aborted, exiting now"
        }
        failure {
            githubNotify context: 'continuous-integration/jenkins/SGX-SIM mode', description: 'commit looks bad',  status: 'FAILED'
